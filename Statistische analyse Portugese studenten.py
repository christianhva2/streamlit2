...
#Als iemand lager dan 10 punten heeft tescoord, heeft deze persoon het vak niet gehaald, er wordt dan meteen een 0 genoteerd, daarom alleen cijfers > 10.
    ...
    if image_option:
        st.image('/Users/christianrombouts/Downloads/Minor Data Science/Cases/Eindpresentatie VA/afbeelding.png',
                caption = 'Portugese cijfersysteem, via gradecalculator (2021)', use_column_width = True)
